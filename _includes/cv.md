...
<td>
    <strong>16. Think Then Embed: Generative Context Improves Multimodal Embedding</strong><br>
    X. Cui, J. Cheng, H. Chen, S. Shukla, A. Awasthi, X. Pan, <strong>C. Ahuja</strong>, S. Mishra, T. Tian, Q. Guo, S. Lim, A. Singh, and X. Fan<br>
    ICLR 2026<br>
    
     
<a href='javascript: none'
    onclick='$("#abs_cui2025a").toggle()'><button type='button' class='btn btn-danger'>abs</button></a> <a href='https://arxiv.org/abs/2510.05014' target='_blank'><button type='button' class='btn btn-primary'>pdf</button></a> <br>
...
<tr>
<td class="col-md-3"><a href='https://openaccess.thecvf.com/content/ICCV2023/papers/Lee_Lecture_Presentations_Multimodal_Dataset_Towards_Understanding_Multimodality_in_Educational_Videos_ICCV_2023_paper.pdf' target='_blank'><img src="pics/publications/lee2022multimodal.png"/></a> </td>
<td>
    <strong>13. Lecture Presentations Multimodal Dataset: Towards Understanding Multimodality in Educational Videos</strong><br>
